...
public abstract class InputSurfaceView extends SurfaceView {
    private static final String TAG = InputSurfaceView.class.getSimpleName();
    ...
    public InputSurfaceView(Context context, int fps) {
        this(context, null, 0);
        mFps = fps;
    }

    public InputSurfaceView(Context context, AttributeSet attrs) {
     ...
     */
    public InputSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return this
     */
    public InputSurfaceView addChild(@NonNull DisplayBase DisplayBase) {
     ...
     * @return this
     */
    public InputSurfaceView addChildAt(int location, @NonNull DisplayBase DisplayBase) {
        DisplayBase.setUp(mFps);
     ...
     * @return this
     */
    public InputSurfaceView removeChild(@NonNull DisplayBase displayBase) {
        displayBase.disable();
     ...
     * @return this
     */
    public InputSurfaceView removeChildAt(int location) {
     ...
     * @return this
     */
    public InputSurfaceView removeAllChildren() {
        mDisplayList.clear();
        return this;
    }
